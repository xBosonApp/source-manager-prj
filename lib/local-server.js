 ...
 * MIT licensed.
 * 
 * 改项目来自 http://registry.npmjs.org/npm-server
 */
...
var console = require('logger-lib')('local');
...
function startup(_opts) {
  ...
  .listen(opts.port, opts.host, function() {
    ...
    console.log(' parent  : %s:%s', opts.parent_host, opts.parent_port);
  });
}
...
function forward(req, res) {
  ...
  var out = {};
  out.host = opts.parent_host || 'registry.npmjs.org';
  out.port = opts.parent_port || 80;
